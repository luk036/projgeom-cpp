...
namespace fun {
     ...
     * @tparam Line Line
     */
    template <class Point, class Line> concept ProjectivePlanePrimH
        = STD_ALT::equality_comparable<Point> &&requires(const Point &pt_p, const Point &pt_q,
                                                         const Line &ln_l) {
        { incident(pt_p, ln_l) }
        ->STD_ALT::convertible_to<bool>;  // incidence
        { pt_p *pt_q }
        ->STD_ALT::convertible_to<Line>;  // join or meet
     ...
     * @tparam Line Line
     */
    template <class Point, class Line = typename Point::Dual> concept ProjectivePlanePrim
     ...
     * @tparam Point Point
     */
    template <class Point> concept ProjectivePlanePrim2
     ...
     * @tparam Line Line
     */
    template <class Point, class Line = typename Point::Dual> concept ProjectivePlaneGenericH
     ...
     * @tparam Line Line
     */
    template <class Point, class Line = typename Point::Dual> concept ProjectivePlaneGeneric
     ...
     * @tparam Point Point
     */
    template <class Point> concept ProjectivePlaneGeneric2
     ...
     * @tparam Line Line
     */
    template <class Point, class Line> concept ProjectivePlaneH
        = STD_ALT::equality_comparable<Point> &&requires(const Point &pt_p, const Point &pt_q,
                                                         const Line &ln_l,
     ...
     * @tparam Line Line
     */
    template <class Point, class Line = typename Point::Dual> concept ProjectivePlane
    ...
    */
     ...
     * @tparam Point Point
     */
    template <class Point> concept ProjectivePlane2
     ...
     * @tparam Line Line
     */
    template <class Point, class Line> concept ProjectivePlaneCoordH
     ...
     * @tparam Line Line
     */
    template <class Point, class Line = typename Point::Dual> concept ProjectivePlaneCoord
     ...
     * @tparam Point Point
     */
    template <class Point> concept ProjectivePlaneCoord2
