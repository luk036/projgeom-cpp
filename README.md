...
The single root `CMakeLists.txt` defines the library, standalone executable, benchmark and tests.
...
The documentation is automatically built and [published](https://luk036.github.io/projgeom-cpp) whenever a [GitHub Release](https://help.github.com/en/github/administering-a-repository/managing-releases-in-a-repository) is created.
...
- [**projgeom-simple**](https://github.com/luk036/projgeom-simple): Simplified header-only variant (xmake/CMake, lighter CI)
