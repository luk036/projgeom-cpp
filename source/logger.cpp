 ...
 *
 * This file implements the logging functionality for the projgeom library
...
namespace projgeom {
    ...
    auto make_file_logger() noexcept -> std::shared_ptr<spdlog::logger> {
        auto l = spdlog::basic_logger_mt("file_logger", "projgeom.log");
     ...
     *
     * This function creates a file logger that writes to "projgeom.log",
    ...
    void log_with_spdlog(const std::string& message) {
        ...
        spdlog::info("ProjGeom message: {}", message);
    }
